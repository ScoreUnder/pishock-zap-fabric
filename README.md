...
|---------------------------------|-----------------------|-----------------------|--------------------------------------|------------------------|---------------------------|---------------------------|----------------------------------------------|
| Minecraft versions              | 1.17.x - 26.2         | 1.21.x                | 1.21                                 | 1.19.x, 1.20.x, 1.21.x | 1.19.3, 1.19.4            | Wide range                | 1.18.2                                       |
...
| Actively maintained             | :white_check_mark:    | :white_check_mark:    | Archived 2025-03-15                  | Archived 2024-10-26    | Inactive since 2023-03-24 | Inactive since 2023-04-21 | :x:                                          |
...
| Low-latency local serial API    | :white_check_mark:    | :white_check_mark:    | :white_check_mark:                   | :x:                    | :x:                       | :x:                       | :x:                                          |
...
| API connectivity checks         | :white_check_mark:    | :white_check_mark:    | :white_check_mark:                   | :white_check_mark:     | :x:                       | :x:                       | :x:                                          |
| Vibration test button           | :white_check_mark:    | :white_check_mark:    | :x:                                  | :white_check_mark:     | :x:                       | :x:                       | :x:                                          |
| In-game quick toggle            | Via hotkey or command | Via hotkey            | :x:                                  | :x:                    | Via command               | :x:                       | :x:                                          |
